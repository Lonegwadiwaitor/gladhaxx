...
#ifndef VM_CAT_WHITE_START
#define VM_CAT_WHITE_START \
  __asm _emit 0xEB \
  __asm _emit 0x10 \
  __asm _emit 0x57\
  __asm _emit 0x4C\
...
#ifndef VM_CAT_WHITE_END
#define VM_CAT_WHITE_END \
  __asm _emit 0xEB \
  __asm _emit 0x10 \
  __asm _emit 0x57\
  __asm _emit 0x4C\
...
#ifndef VM_CAT_BLACK_START
#define VM_CAT_BLACK_START \
  __asm _emit 0xEB \
  __asm _emit 0x10 \
  __asm _emit 0x57\
  __asm _emit 0x4C\
...
#ifndef VM_CAT_BLACK_END
#define VM_CAT_BLACK_END \
  __asm _emit 0xEB \
  __asm _emit 0x10 \
  __asm _emit 0x57\
  __asm _emit 0x4C\
