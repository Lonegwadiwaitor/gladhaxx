...
#define LUA_CALLINFO_SIRMEMEHUB (1 << 3) // this is a sirmeme hub closure and should be executed on our VM.
...
typedef struct global_State
{
    ...
    VM_SHUFFLE5(;, struct lua_State* mainthread,
        ...
        GLOBAL_OBFUSCATED_TTNAME ttname[LUA_T_COUNT],       // names for basic types
        GLOBAL_OBFUSCATED_TMNAME tmname[TM_N]);         // array with tag-method names
...
public:
    ...
    int32_t identity; //0x0018
    char pad_001C[12]; //0x001C
    int32_t ScriptContext; //0x0028
    char pad_002C[12]; //0x002C
    class Instance* current_script; //0x0038
...
struct  lua_State
{
    ...
    LS_STACKSIZE_OBFUSCATION stacksize;
    ...
    VM_SHUFFLE3(; , Table* gt,           // table of globals
