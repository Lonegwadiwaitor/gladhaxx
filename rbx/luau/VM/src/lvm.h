...
LUAI_FUNC void resolveImportSafe(lua_State* L, Table* env, TValue* k, uint32_t id);
LUAI_FUNC std::optional<std::string> luaV_getimportname(lua_State* L, Table* env, TValue* k, StkId res, uint32_t id, bool propagatenil);
